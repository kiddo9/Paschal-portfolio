    ...
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg font-sans">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          system performance. Passionate about for building scalable, real-time
          applications .
        </p>
      </section>
      ...
      {/* Projects */}
      <section className="mb-8">
        <h3 className="text-2xl font-bold text-gray-800 mb-4">Key Projects</h3>
        ...
        <div className="space-y-4">
          <div className="border rounded-lg p-4 bg-gray-50">
            ...
            <p className="text-gray-700 mb-2">
              ...
              implemented Implemented modern React frontend with Node.js backend
              and PostgreSQL database.
            </p>
            <p className="text-sm text-gray-600">
              <strong>Technologies:</strong> React, Node.js, PostgreSQL, Azure,
              Docker, Nginx, Tailwindcss
            </p>
          </div>
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            ...
            <p className="text-gray-700 mb-2">
              Built a real-time chat web application where users can send friend
              request and chat in real time using redis for cacheing and pusher
              as a websocket for real time update
            </p>
            <p className="text-sm text-gray-600">
              <strong>Technologies:</strong> Laravel, Livewire, javascript, php,
              Redis, pusher, docker, github actions, ci/cd
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700">
          Open Source Development, Machine Learning, Rock Climbing, Blockchain,
          Traveling, Cooking
        </p>
      </section>
